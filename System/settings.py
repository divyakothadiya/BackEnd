...
SECRET_KEY = 'django-insecure-(js70@36nih60&7i^30&8wgrp7=6j$wm&qs1^mf(syk_sz%=l3'
...
CORS_ALLOWED_ORIGINS = [
    "http://localhost:3000",
    "http://127.0.0.1:3000"  # or your frontend domain
]
...
#Jwt auto generate tocken and expires details
